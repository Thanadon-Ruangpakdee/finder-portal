...
const createSvgIcon = (svgContent) => {
  return function Icon({ size = 20, className = '', color = 'currentColor', style = {}, ...props }) {
    return (
      <svg
...
export const Globe2 = createSvgIcon(
  <>
    <circle cx="12" cy="12" r="10" />
...
export const Code2 = createSvgIcon(
  <>
...
export const Loader2 = createSvgIcon(
...
export const Sliders = createSvgIcon(
  <>
...
export const Maximize2 = createSvgIcon(
  <>
    <polyline points="15 3 21 3 21 9" />
