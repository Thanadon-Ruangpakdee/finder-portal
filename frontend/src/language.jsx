...
const TH = {
  ...
  'Manage your profile identity, notification preferences, and Active Directory session status.':
    'จัดการข้อมูลโปรไฟล์ ช่องทางติดต่อ การแจ้งเตือน และสถานะเซสชัน Active Directory ของคุณ',
  'Profile Customization': 'ปรับแต่งโปรไฟล์และข้อมูลติดต่อ',
  ...
  'Mobile Phone / LINE ID': 'เบอร์โทรศัพท์ / LINE ID',
  'e.g. 081-234-5678 or Line ID for pickup': 'เช่น 081-234-5678 หรือ LINE ID สำหรับติดต่อรับของคืน',
  'Optional contact for security desk verification': 'ช่องทางติดต่อสำหรับยืนยันรับของกับฝ่ายรักษาความปลอดภัย',
  ...
  'Email Alerts for Claims': 'แจ้งเตือนทางอีเมลเมื่อมีคำร้อง',
  'Receive email updates when status or claim updates occur': 'รับอีเมลเมื่อมีการอนุมัติ หรือเปลี่ยนแปลงสถานะคำร้อง',
  'Gemini AI Match Notifications': 'แจ้งเตือนเมื่อ AI พบคู่ของที่ตรงกัน',
  'Get notified when AI discovers a lost & found match': 'รับการแจ้งเตือนเมื่อ Gemini AI ค้นพบคู่ของหาย–ของเจอที่ตรงกัน',
  'In-App Toast Alerts': 'การแจ้งเตือนป๊อบอัพในหน้าเว็บ',
  'Show real-time alerts inside the portal': 'แสดงป๊อบอัพแจ้งเตือนแบบเรียลไทม์ขณะใช้งานระบบ',
  'AD Security & Integrations': 'เซสชันความปลอดภัย AD และการเชื่อมต่อระบบ',
  'System Integration Status': 'สถานะการเชื่อมต่อระบบอื่น',
  'SSO Authenticated': 'ยืนยันตัวตนผ่าน SSO เรียบร้อย',
  'Bilateral Sync Active': 'เชื่อมต่อแล้ว (พร้อมรับส่งข้อมูล)',
